...
#endif
#if defined(RT_HW_BOARD_CHECK_PIN)					//--Установка разрешение проверки на допустимость
device.board.permitCheckPin=1;						//  использования пинов [функции checkPinXXX(uint8_t pin)];
#else
device.board.permitCheckPin=0;	
#endif
//=================================================================================================
