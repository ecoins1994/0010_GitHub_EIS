...
if(z2Hour.custom==0)    {RT_HW_lcd44780.initByteID(z2Hour,     n2,'U','L','~',13,4,3);} RT_HW_lcd44780.LcdVAR  (z2Hour,        timeHour);
if(z2Min.custom==0)     {RT_HW_lcd44780.initByteID(z2Min,      n2,'U','L','~',15,4,3);} RT_HW_lcd44780.LcdVar  (z2Min, z2hTime,timeMin);
if(z2Sec.custom==0)     {RT_HW_lcd44780.initByteID(z2Sec,      n2,'U','L','~',18,4,3);} RT_HW_lcd44780.LcdVar  (z2Sec, z2hTime,timeSec);
