...
if(z2Cr1Ok.custom==0)  {RT_HW_lcd44780.initBitID(z2Cr1Ok,     n2,            11,3);}    RT_HW_lcd44780.LcdBit  (z2Cr1Ok,  vCr1Ok);     
if(z2Cr1Cnt.custom==0) {RT_HW_lcd44780.initByteID(z2Cr1Cnt,  n2,'U','L','~',12,3,2);}   RT_HW_lcd44780.LcdVAR  (z2Cr1Cnt, vCr1Cnt);
if(z2Speed.custom==0)  {RT_HW_lcd44780.initWordID(z2Speed,   n2,'U','R','~',18,3,3);}   RT_HW_lcd44780.LcdVAR  (z2Speed,    vCr1SpeedSmall);        //--Speed/1000  output;
//--------------------------------------------------------------------------------------
};
