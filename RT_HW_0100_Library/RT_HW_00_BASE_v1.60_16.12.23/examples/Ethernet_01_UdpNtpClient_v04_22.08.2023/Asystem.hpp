...
//-------------------------------------------------------------------------------------------------
  ...
  csEthernet  =RT_HW_Base.device.spi.cs2;   //--cs Ethernet;
...
//=====================================================================================================
//                                    2.7.Получение времени (часы,минуты,секунды) из timeUNIX
//=====================================================================================================
uint8_t  getTimeHour(uint32_t timeUNIX, uint8_t timeZone=3){return ((timeUNIX+(timeZone*3600UL)) % 86400L)/3600;}
uint8_t  getTimeMin (uint32_t timeUNIX, uint8_t timeZone=3){return ((timeUNIX+(timeZone*3600UL)) % 3600)  /60;}
uint8_t  getTimeSec (uint32_t timeUNIX, uint8_t timeZone=3){return ( timeUNIX+(timeZone*3600UL)) % 60;} 
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
