...
if(z1ADC.custom==0)  {RT_HW_lcd44780.initWordID  (z1ADC,  n1,'U','L',';', 2,1,4); z1ADC.periodLimit=20;} RT_HW_lcd44780.LcdVAR(z1ADC,vADCF); //--ADC output(no header);
if(z1BMPok.custom==0){RT_HW_lcd44780.initBitID   (z1BMPok,n1,6,1);}                RT_HW_lcd44780.LcdBit  (z1BMPok,vBMP180_ok,'-','+'); //--Sensor ok   output;
if(z1Press.custom==0){RT_HW_lcd44780.initFloatID (z1Press,n1,'1','L',';', 7,1,7);} RT_HW_lcd44780.LcdFLOAT(z1Press,vBMP180_Press);      //--Pressure    output;
