...
#define   RT_HW_BASE_h
//=================================================================================================
#define   RT_HW_BASE_VER 		 (uint8_t)170				//--Номер версии;
#define   RT_HW_BASE_VER_NAME 	"1.7.0 01.01.2024"			//--Наименование версии;
//=================================================================================================
...
uint8_t                 vInit=0;							//--Флаг инициализациии параметров(полезно для многоядерных MCU);
//uint8_t                 customETH=0;							//--Флаг инициализациии Ethernet;
...
#include "BASE_100_API System/API_110_FuncEthernet.hpp"		//--API функций для Ethernet,Wi-Fi;
#include "BASE_100_API System/API_111_Sheduler.hpp"			//--API функций для диспетчера, управление вызовом задач;
#include "BASE_100_API System/API_120_UnixTime.hpp"			//--API функций для времени в UNIX-формате;
//-------------------------------------API for FLProg----------------------------------------------
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//										КЛАССЫ ДЛЯ РАБОТЫ С ДОПОЛНИТЕЛЬНЫМИ ФУНКЦИЯМИ
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//#include "BASE_400_API Func/API_100_Class_UnixTime.hpp"		//--API работа с временем UNIX;
