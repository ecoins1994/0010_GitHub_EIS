...
//=================================================================================================
uint32_t genRandom(uint32_t base=0, uint8_t depth=24){
buff.vu32=buff.vRandom+base+RT_HW_MICROS+unixID.timeUNIX+device.board.codeArch+device.board.codeBoard;	//--Здесь могут быть дополнительные компоненты (например температура процессора);
buff.vu32=buff.vu32*1103515245 + 12345678;  // Линейный метод;
if((depth!=8) && (depth!=16) && (depth!=24) && (depth!=32)) {depth=8;}
if(depth ==8){buff.vRandom=(buff.vu32>>24) % 0xFF;}     	// Вернуть значение в диапазоне 0-255;
if(depth==16){buff.vRandom=(buff.vu32>>16) % 0xFFFF;}     	// Вернуть значение в диапазоне 0-65535;
if(depth==24){buff.vRandom=(buff.vu32>> 8) % 0xFFFFFF;}     // Вернуть значение в диапазоне 0-16777215;
if(depth==32){buff.vRandom=buff.vu32;}     					// Вернуть значение в диапазоне 0-4294967295;
return buff.vRandom;}
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
