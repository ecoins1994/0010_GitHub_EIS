...
static char reg; static uint8_t idx; static uint8_t jdx;
if(pin>=254) {return String(F("  *"));}	
for(idx=0; idx<=8; idx++){reg=char(((uint8_t)'A')+idx); for(jdx=0; jdx<16; jdx++){
		if(getNumPinSTM32(reg,jdx)==pin) {return (String('P') +String(reg)+String(jdx));}}}	
...
//=================================================================================================
//							ФУНКЦИИ ПОЛУЧЕНИЯ НОМЕРОВ ПИНОВ 
//=================================================================================================
