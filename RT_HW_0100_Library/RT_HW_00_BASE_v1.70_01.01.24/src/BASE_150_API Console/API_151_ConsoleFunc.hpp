...
//=================================================================================================
//		   						2.8.OUTPUT of test variables when changing
//=================================================================================================
...
//=================================================================================================
//		   						2.9.OUTPUT of test array when changing
//=================================================================================================
//----------------------------------int16_t  arr[]-------------------------------------------------
...
//=================================================================================================
void  consoleCurrentTime(char suff='~'){
consoleVar(unixID.hours,  	':', 3,'T');
consoleVar(unixID.minutes,	':', 3,'T');
consoleVar(unixID.seconds,	suff,3,'T');
};
//=================================================================================================
//							3.2.Вывод текущей даты
//=================================================================================================
void  consoleCurrentDate(char suff='~'){
consoleVar(unixID.day,  	':', 3,'T');
consoleVar(unixID.month,	':', 3,'T');
consoleVar(unixID.year2,	suff,3,'T');
};
//=================================================================================================
//							3.3.Вывод текущей даты с день недели
//=================================================================================================
void  consoleCurrentDateWeek(char suff='~'){
consoleVar(unixID.day,      ':' ,3,'T');
consoleVar(unixID.month,    ':' ,3,'T');
consoleVar(unixID.year2,    ' ' ,3,'T');
consoleVar(unixID.weekDay,  suff,2,'U');
};
//=================================СИСТЕМНЫЕ ФУНКЦИИ===============================================
//=================================================================================================
