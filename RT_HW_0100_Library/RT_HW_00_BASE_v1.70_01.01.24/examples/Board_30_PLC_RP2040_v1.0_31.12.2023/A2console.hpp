...
RT_HW_Base.consoleCR(); RT_HW_Base.genMacAddr();
                         RT_HW_Base.consoleTestArr(String(F("MAC addres")),RT_HW_Base.buff.mac,'E','H',6);                         
//RT_HW_Base.genMacAddr(); RT_HW_Base.consoleTestArr(String(F("MAC addres")),RT_HW_Base.buff.mac,'E','H',6);
//RT_HW_Base.genMacAddr(); RT_HW_Base.consoleTestArr(String(F("MAC addres")),RT_HW_Base.buff.mac,'E','H',6);
//RT_HW_Base.genMacAddr(); RT_HW_Base.consoleTestArr(String(F("MAC addres")),RT_HW_Base.buff.mac,'E','H',6);
//------------------------------------------------------------------------------------------------
