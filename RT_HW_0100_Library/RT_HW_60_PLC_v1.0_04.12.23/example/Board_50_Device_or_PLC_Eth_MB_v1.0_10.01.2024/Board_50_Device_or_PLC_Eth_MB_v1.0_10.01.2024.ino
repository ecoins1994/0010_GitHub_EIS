...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//                    0.2.Разрешения использования как PLC
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  #define RT_HW_TEST_PERMIT_PLC_RP_55   //--Разрешение использования как PLC RP2040
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//                    0.6.Разрешения использования работы с ModBus
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  #define RT_HW_TEST_PERMIT_ModbusMasterRTU //----Разрешение тестов работы с Modbus Master RTU;
  #define RT_HW_TEST_PERMIT_ModbusSlaveRTU  //----Разрешение тестов работы с Modbus Slave  RTU;
...
//================================================================================================= 
  if(shed.frdm.num== 4) {fncSetStatus();}         //--Установка флагов состояния системных и других устройств; 
...
//================================================================================================= 
  ...
  if(shed.frdm.num==17){expDotPLC();}             //--Вывод на выходы PLC;
//-------------------------------------------------------------------------------------------------
