...
//-------------------------------------------------------------------------------------------------
//                                   2.1.7.Переобозначение параметров под ПЛК RP2040 5.5
//-------------------------------------------------------------------------------------------------
#if defined(RT_HW_TEST_PERMIT_PLC_RP_55)
pinControl=RT_HW_Base.device.pin.control=255;  //--Запрет пина Led;
pinLed=RT_HW_Base.device.pin.led=255;      //--Запрет пина Led;
pinButton=RT_HW_Base.device.pin.button=255;   //--Запрет пина Кнопки;
pinPWM=RT_HW_Base.device.pin.pwm=255;      //--Запрет пина PWM;
pinADC=RT_HW_Base.device.pin.adc=255;      //--Запрет пина ADC; 
pinDS1820=RT_HW_Base.device.dev.oneWire=255;  //--Запрет пина 1-Wire;
pinDHT22=RT_HW_Base.device.dev.dht22=255;    //--Запрет пина DHT22;
pinSR04=RT_HW_Base.device.dev.sr04=255;     //--Запрет пина HC-SR04.trig;
csDM13C=255;       
csMAX6675=255;
cs74HC595=255;
cs595PLC=17;
RT_HW_Base.device.uart.nextion=3;   //--Установка номера UART для Nextion;
#endif
};
//=====================================================================================================
