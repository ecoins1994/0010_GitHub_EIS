...
if(id.modePin=='A') {if(id.size<9) {id.size=9;} id.alig='L'; id.str=getNamePin(v); id.str+=String('['); 
...
if(id.modePin=='T') {if(id.size<3) {id.size=3;}              id.str=getNamePin(v); id.str+=Strig(' ');  return;}
if(id.modePin=='A') {if(id.size<7) {id.size=7;}              id.str=getNamePin(v); id.str+=+String('['); 
                     if(v<254){id.str+=String(v);}      else{id.str+=String('*');} id.str+=String(']'); return;}
if(id.modePin=='D') {if(v<254){id.str+=String(v);}      else{id.str+=String('*');}                      return;}                    
id.str+=String('*'); return;
#endif
...
//-------------------------------------------------------------------------------------------------
if((id.modeAdr=='H') || (id.modeAdr=='A')){id.str+=String(F("0x")); if(v<0x0F) {id.str+=String('0');} id.str+=String(v,HEX); 
                      if(id.modeAdr=='A') {id.str+=String('/'); id.str+=String(v);}  return;} 
//-------------------------------------------------------------------------------------------------
id.str=String(v); return;};

//=================================================================================================
//								3.10.Формирование строки с IP Ethernet
//=================================================================================================
void ethernetIPtoMess(RT_HW_STRUCT_MESS &id, uint8_t e3, uint8_t e2, uint8_t e1, uint8_t e0){
id.str =String(F(""));
id.str =String(e3); id.str+=String('.');
id.str+=String(e2); id.str+=String('.');
id.str+=String(e1); id.str+=String('.');
id.str+=String(e0);
};
void ethernetIPtoMess(uint8_t e0, uint8_t e1, uint8_t e2, uint8_t e3){ethernetIPtoMess(mess,e0,e1,e2,e3);};
void ethernetIPtoMess(uint32_t et){ethernetIPtoMess(mess,((et>>24)&0xFF),((et>>16)&0xFF),((et>>8)&0xFF),((et)&0xFF));};
//=================================================================================================
//								3.11.Формирование строки с IP Ethernet
//=================================================================================================
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//						    		4.СЕРВИСНЫЕ ФУНКЦИИ
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
