...
//=================================================================================================
  #define RT_HW_PERMIT_UART0				//--Разрешение использования UART0;
  #define RT_HW_PERMIT_UART1				//--Разрешение использования UART1;
  #define RT_HW_PERMIT_UART2				//--Разрешение использования UART2;
//-------------------------------------------------------------------------------------------------
  #define RT_HW_PERMIT_I2C0					//--Разрешение использования i2c0;
  #define RT_HW_PERMIT_I2C1					//--Разрешение использования i2c1;
//-------------------------------------------------------------------------------------------------
  #define RT_HW_PERMIT_SPI0					//--Разрешение использования SPI0;
  #define RT_HW_PERMIT_SPI1					//--Разрешение использования SPI1;
//-------------------------------------------------------------------------------------------------
//#define RT_HW_PERMIT_CAN					//--Разрешение использования CAN;
//-------------------------------------------------------------------------------------------------
  #define RT_HW_PERMIT_DAC					//--Разрешение использования DAC;
//-------------------------------------------------------------------------------------------------
  #define RT_HW_PERMIT_HALL					//--Разрешение использования датчика Холла;
//#define RT_HW_PERMIT_WS					//--Разрешение использования датчика  WS2812;
//=================================================================================================
//							1.2 .Разрешения создания объектов для устройств коммуникаций
//=================================================================================================
#define RT_HW_CREATE_SPI1					//--Разрешение создание объекта для SPI1;

//=================================================================================================
//									1.3. Пины устройств коммуникаций
//=================================================================================================												
//--------------------------------Параметры UART---------------------------------------------------	
