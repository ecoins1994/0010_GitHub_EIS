...
//=================================================================================================
  ...
  #define RT_HW_BLOCK_CHECK_PIN	 			//--Блокировка контроля допустимости номеров пинов;
  #define RT_HW_BLOCK_QUICK_PIN				//--Блокировка функций быстрой работы с пинами(используются функции IDE);
//-------------------------------------------------------------------------------------------------
