...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  #define 	RT_HW_BOARD_SELECT       "BOARD AVR Arduino Nano" 	//--Идентификатор выбора платы
//=================================================================================================
//							1.1.Разрешения использования устройств
//=================================================================================================
  #define RT_HW_PERMIT_COMPACT				//--Разрешение оптимизации используемых ресурсов;
//-------------------------------------------------------------------------------------------------
  #define RT_HW_PERMIT_UART0				//--Разрешение работы с UART0; 
//#define RT_HW_PERMIT_UARTS				//--Разрешение работы с SoftSerial(для миним.занимаемой памяти может задаваться извне);
...
//=================================================================================================
  enum {RT_HW_UART0_RX=0, 	RT_HW_UART0_TX=1, RT_HW_UART0_DE=255};	//--Пины для Serial;
  enum {RT_HW_UARTS_RX=8, 	RT_HW_UARTS_TX=9, RT_HW_UARTS_DE=255}; 	//--Пины для SoftSerial;
  enum {RT_HW_I2C0_SDA=18,	RT_HW_I2C0_SCL=19}; 					//--Пины для i2c	
  enum {RT_HW_SPI0_SCK=13,  RT_HW_SPI0_MISO=12,  RT_HW_SPI0_MOSI=11,  RT_HW_SPI0_SS=10};//--Пины для SPI;	
//=================================================================================================
...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  #define 	RT_HW_BOARD_SELECT       "BOARD AVR Arduino UNO" 	//--Идентификатор выбора платы	
//=================================================================================================
//							2.1.Разрешения использования устройств
//=================================================================================================
...
//#define RT_HW_PERMIT_UARTS				//--Разрешение работы с SoftSerial(для миним.занимаемой памяти может задаваться извне);
  ...
  #define RT_HW_PERMIT_SPI0					//--Разрешение работы с SPI0; 
//=================================================================================================
//							2.2.Разрешения создания объектов
//=================================================================================================
  #define RT_HW_CREATE_UARTS  				//--Разрешение создание объекта SoftSerial;
//=================================================================================================
//							2.3.Значения пинов для коммуникационных устройств
//=================================================================================================	
  enum {RT_HW_UART0_RX=0, 	RT_HW_UART0_TX=1, RT_HW_UART0_DE=255};	//--Пины для Serial;
  enum {RT_HW_UARTS_RX=8, 	RT_HW_UARTS_TX=9, RT_HW_UARTS_DE=255}; 	//--Пины для SoftSerial;
  enum {RT_HW_I2C0_SDA=18,  RT_HW_I2C0_SCL=19}; 					//--Пины для i2c0;
  enum {RT_HW_SPI0_SCK=13,  RT_HW_SPI0_MISO=12,  RT_HW_SPI0_MOSI=11,  RT_HW_SPI0_SS=10};	//--Пины для SPI0;
//=================================================================================================
...
//=================================================================================================
  ...
  const uint8_t PROGMEM RT_HW_PGM_PIN_N5V[]	={																	RT_HW_PGM_END};		
//=================================================================================================
//							2.5.Таблица пинов коммуникационных устройств и внешней памяти
//=================================================================================================
const uint8_t PROGMEM RT_HW_PGM_PIN_UHS[]	={RT_HW_UART0_RX, RT_HW_UART0_TX, RT_HW_UART0_DE, RT_HW_PGM_END}; //--UART0:rx,tx,de;																  						
//-------------------------------------------------------------------------------------------------
const uint8_t PROGMEM RT_HW_PGM_PIN_USS[]	={RT_HW_UARTS_RX, RT_HW_UARTS_TX, RT_HW_UARTS_DE, RT_HW_PGM_END}; //--UARTS:rx,tx,de; 
...
//=================================================================================================
//							3.1.Разрешения использования устройств
//=================================================================================================
  #define RT_HW_BOARD_CHECK_PIN				//--Разрешение проверки на допустимость использования пинов [функции checkPinXXX(uint8_t pin)];
//-------------------------------------------------------------------------------------------------
  #define RT_HW_PERMIT_UART0				//--Разрешение работы с UART0; 
...
//#define RT_HW_PERMIT_UARTS				//--Разрешение работы с SoftSerial;	
  ...
  #define RT_HW_PERMIT_SPI0					//--Разрешение работы с SPI0; 
//=================================================================================================
//							3.2.Разрешения создания объектов
//=================================================================================================
  #define RT_HW_CREATE_UARTS  				//--Разрешение создание объекта SoftSerial;
//=================================================================================================
//							3.3.Значения пинов для коммуникационных устройств
//=================================================================================================	
  enum {RT_HW_UART0_RX=0,   RT_HW_UART0_TX=1,   RT_HW_UART0_DE=38,		//--Пины для Serial;
	    RT_HW_UART1_RX=19,  RT_HW_UART1_TX=18,  RT_HW_UART1_DE=39,		//--Пины для Serial1; 
	    RT_HW_UART2_RX=17,  RT_HW_UART2_TX=16,  RT_HW_UART2_DE=40,		//--Пины для Serial2;
	    RT_HW_UART3_RX=15,  RT_HW_UART3_TX=14,  RT_HW_UART3_DE=41};		//--Пины для Serial3;
  enum {RT_HW_I2C0_SDA=20,  RT_HW_I2C0_SCL=21}; 						//--Пины для i2c;
  enum {RT_HW_SPI0_SCK=52,  RT_HW_SPI0_MISO=50,  RT_HW_SPI0_MOSI=51,  RT_HW_SPI0_SS=53};  //--Пины SPI;
//=================================================================================================
//							3.4.Таблица доступных пинов контроллера
//=================================================================================================
...
//=================================================================================================
//							3.5.Таблица пинов коммуникационных устройств и внешней памяти
//=================================================================================================
