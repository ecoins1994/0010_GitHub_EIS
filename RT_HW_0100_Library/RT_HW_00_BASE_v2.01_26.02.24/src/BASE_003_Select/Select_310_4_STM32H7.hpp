...
#define      RT_HW_BOARD_CODE     (uint16_t)120         					//--Идентификатор выбора платы c кодом платы;
...
#define      RT_HW_BOARD_FCPU     (uint16_t)480 							//--Частота процессора;	
...
#define      RT_HW_BOARD_CODE     (uint16_t)121         					//--Идентификатор выбора платы c кодом платы;
