...
//-------------------------------------------------------------------------------------------------
#define 	RT_HW_BOARD_FCPU   	(uint16_t)84						//--Freq MCU;	
#define 	RT_HW_BOARD_VCC   	(uint16_t)3300						//--Vсс  MCU;
#define 	RT_HW_BOARD_QNT    	(uint16_t)30						//--Number of pins;
#define 	RT_HW_BOARD_CODE   	(uint16_t)131 						//--ID select board Arduino IDE;
...
#define 	RT_HW_BOARD_VCC   	(uint16_t)3300						//--Vсс  MCU;
#define 	RT_HW_BOARD_QNT    	(uint16_t)30						//--Number of pins;
#define 	RT_HW_BOARD_CODE   	(uint16_t)132 						//--ID select board Arduino IDE;
...
//-------------------------------------------------------------------------------------------------
#define 	RT_HW_BOARD_FCPU   	(uint16_t)100						//--Freq MCU;	
#define 	RT_HW_BOARD_VCC   	(uint16_t)3300						//--Vсс  MCU;
#define 	RT_HW_BOARD_QNT    	(uint16_t)30						//--Number of pins;
#define 	RT_HW_BOARD_CODE   	(uint16_t)133 						//--ID select board Arduino IDE;
...
#define 	RT_HW_BOARD_VCC   	(uint16_t)3300						//--Vсс  MCU;
#define 	RT_HW_BOARD_QNT    	(uint16_t)30						//--Number of pins;
#define 	RT_HW_BOARD_CODE   	(uint16_t)134 						//--ID select board Arduino IDE;
