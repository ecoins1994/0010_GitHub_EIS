...
if(RT_HW_Base.shed.slow.num==2){
  ...
  MasterRTU1.saveInteger(1,2012,                      FLPROG_HOLDING_REGISTR, 1); //--ADC;
  MasterRTU1.saveInteger(1,123,                       FLPROG_HOLDING_REGISTR, 2); //--HC-SR04;
...
if(RT_HW_Base.shed.slow.num==3){
  ...
  MasterRTU1.saveFloat  (2,18.123,      FLPROG_HOLDING_REGISTR, 8); //--DS1820;
