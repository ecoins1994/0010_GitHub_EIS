...
//if(z1CrGn1.custom==0){RT_HW_lcd44780.initByteID  (z1CrGn1,n1,'U','L','~',7,1,2);} RT_HW_lcd44780.LcdVAR  (z1CrGn1,vcoreCnt);          //--Счетчик при работе CORE1;
//--------------------------------------------------------------------------------------
if(z1Speed2.custom==0){RT_HW_lcd44780.initWordID (z1Speed2,n1,'U','R',';', 9,1,5);} RT_HW_lcd44780.LcdVAR  (z1Speed2,vspeedSmall);      //--speed/1000  CORE1;
