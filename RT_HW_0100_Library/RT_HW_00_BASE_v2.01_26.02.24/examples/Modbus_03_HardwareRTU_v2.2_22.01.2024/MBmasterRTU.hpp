...
if(shed.slow.num==2){
  ...
  MasterRTU1.saveInteger(1,vSR04Len,    FLPROG_HOLDING_REGISTR, 2); //--HC-SR04;
  MasterRTU1.saveInteger(1,vBH1750Lux,  FLPROG_HOLDING_REGISTR, 3);
  MasterRTU1.saveInteger(1,v74HC165,    FLPROG_HOLDING_REGISTR, 4);
...
if(shed.slow.num==3){
  ...
  MasterRTU1.saveFloat  (2,vDS1820Temp, FLPROG_HOLDING_REGISTR, 8);
