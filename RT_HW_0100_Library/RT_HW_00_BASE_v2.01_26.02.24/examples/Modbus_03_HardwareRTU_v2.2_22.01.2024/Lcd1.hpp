...
if(z1Rg0.custom==0)  {RT_HW_lcd44780.initWordID  (z1Rg0,  n1,'U','L',';', 7,1,3); z1Rg0.periodLimit=20;} RT_HW_lcd44780.LcdVAR(z1Rg0,rg0);   //--Регистр чтения ModBus;
//--------------------------------------------------------------------------------------
if(z1Speed1.custom==0){RT_HW_lcd44780.initLongID (z1Speed1,n1,'U','R','~',11,1,0);} RT_HW_lcd44780.LcdVAR  (z1Speed1,vSpeedMCUF);        //--Speed/1000  CORE0;
//--------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------
if(x1DHTOk.custom==0){RT_HW_lcd44780.initBitID   (x1DHTOk,m1,1,2);}                RT_HW_lcd44780.LcdBit (x1DHTOk,vSHT3x_ok,'-','+');      //--Sensor ok   output;
