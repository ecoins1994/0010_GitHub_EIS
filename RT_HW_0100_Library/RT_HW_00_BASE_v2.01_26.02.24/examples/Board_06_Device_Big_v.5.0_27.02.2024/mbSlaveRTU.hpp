...
if(RT_HW_Base.shed.quick.num==2){
  ...
  SlaveRTU1.saveInteger(vADCF,         FLPROG_HOLDING_REGISTR, 1);  //--ADC
  SlaveRTU1.saveInteger(vSR04_Len,     FLPROG_HOLDING_REGISTR, 2);  //--SR04;
...
if(RT_HW_Base.shed.slow.num==2){
  ...
  SlaveRTU1.saveFloat(vDS1820_Temp,FLPROG_HOLDING_REGISTR, 28);  //--DS1820;     
};
//=================================================================================================
