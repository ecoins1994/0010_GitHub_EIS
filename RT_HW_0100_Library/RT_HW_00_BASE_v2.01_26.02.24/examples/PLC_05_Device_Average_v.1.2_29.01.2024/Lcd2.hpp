...
//if(z2Delta.custom==0)  {RT_HW_lcd44780.initLongID(z2Delta,    n2,'I','R','~',11,3,11);} RT_HW_lcd44780.LcdVAR  (z2Delta,(RT_HW_Base.unixID.timeUNIX-timeUNIX_NTP)); 
//if(z2Ntp.custom  ==0)  {RT_HW_lcd44780.initLongID(z2Ntp,      n2,'U','L','~', 1,4,10);} RT_HW_lcd44780.LcdVAR  (z2Ntp,   timeUNIX_NTP); 
