...
if(z2Delta.custom==0)  {RT_HW_lcd44780.initLongID(z2Delta,    n2,'I','L',';', 1,2,11);} RT_HW_lcd44780.LcdVAR  (z2Delta,(RT_HW_Base.unixID.timeUNIX-getTimeUnixNTP()));   
...
if(z2Ntp.custom  ==0)  {RT_HW_lcd44780.initLongID(z2Ntp,      n2,'U','L',';', 1,4,11);} RT_HW_lcd44780.LcdVAR  (z2Ntp,   getTimeUnixNTP()); 
